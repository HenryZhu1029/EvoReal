...
from LEHD.VRPModel import VRPModel as Model
from LEHD.eval_longTrain import main_test
from LEHD.VRPEnv import VRPEnv as Env
    ...
    def run(self):
        ...
        for epoch in range(self.start_epoch, self.trainer_params['epochs']+1):
            ...
            if all_done or (epoch % model_save_interval) == 0:
                ...
                saved_gap.append([score_optimal, score_student,gap])
                np.savetxt(self.result_folder+'/gap.txt',saved_gap,delimiter=',',fmt='%s')
