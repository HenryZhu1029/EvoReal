...
class VRPEnv:
    ...
    def load_raw_data(self,episode=10000):
        ...
        if self.env_params['mode']=='train':
            ...
            # shape (B )
            self.raw_data_node_flag_1 = torch.tensor(self.raw_data_node_flag_1, dtype=torch.long, requires_grad=False)
            # shape (B,V,2)
            ...
            # shape (B )
            self.raw_data_node_flag_2 = torch.tensor(self.raw_data_node_flag_2, dtype=torch.long, requires_grad=False)
            # shape (B,V,2)
