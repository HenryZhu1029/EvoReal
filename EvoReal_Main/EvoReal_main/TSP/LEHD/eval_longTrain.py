...
from LEHD.TSPTester_inTSPlib import TSPTester as Tester
...
test_paras = {
   # problem_size: [filename, episode, batch]
    ...
    'S1': ['tsplib_typeS1.txt',19,1],
    'S2': ['tsplib_typeS2.txt',12,1],
    'S3': ['tsplib_typeS3.txt', 17, 1],
}
...
def main_test(epoch, checkpoint_path, use_RRC=None,gen_type=None,cuda_device_num=None):
    if DEBUG_MODE:
        _set_debug_mode()
