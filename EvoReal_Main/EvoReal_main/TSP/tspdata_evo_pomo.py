...
class TSPDataEvo:
    def __init__(
        ...
        self.gpt_save_path = os.path.join(self.root_dir, f"{self.log_prefix}_llm_log")
        self.checkpoint_folder = os.path.join(self.root_dir, f"{self.log_prefix}_llm_log", "checkpoints")
        ...
        # Prompt words and reflection
        self.long_term_reflection_str_S1, self.long_term_reflection_str_S2, self.long_term_reflection_str_S3 = "","",""

        # Early Stopping setup
        self.early_stopping_R,self.early_stopping_RC,self.early_stopping_C = False,False,False
