...
def get_data_generator(print_info: bool, module_type: str = "mixed"):
    try:
        if module_type == " S3":
            from evolved_gen.gpt_S3 import generate_s3_type as generator_func
        elif module_type == "S1":
            from evolved_gen.gpt_S1 import generate_s1_type as generator_func
        elif module_type == "S2":
            from evolved_gen.gpt_S2 import generate_s2_type as generator_func
        elif module_type == "mixed":
            from evolved_gen.mixed_generator import tsp_data_generator as generator_func
        else:
